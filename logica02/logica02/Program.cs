...
namespace logica02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Resultado: 1 (sem patênteses): 3 + 5 * 2 = {resultado1}");


            // Exemplo 1: Com parênteses
            int resultado2 = (3 + 5) * 2; //Parênteses alteram a ordem
            Console.WriteLine($"Resultado: 2 (com patênteses): (3 + 5) * 2 = {resultado2}");

            // Exemplo 2: Sem parênteses
            int resultado3 = 8 / 4 + 3; //Divisão tem prioridades
